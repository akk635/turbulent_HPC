    ...
    public:
        ...
        ScalarField ( int Nx, int Ny ){
          // TODO WORKSHEET 1
        	_x = Nx + 3;
        	_y = Ny + 3;
        	scalarfield = new Field<FLOAT> (_x, _y, _z = 0, 1);
        }
        ...
        ScalarField ( int Nx, int Ny, int Nz ){
          // TODO WORKSHEET 1
        	...
        	_y = Ny + 3;
        	_z = Nz + 3;
        	scalarfield = new Field<FLOAT> (_x, _y, _z, 1);
        }
 ...
 */
class VectorField: public Field< Vec23D<FLOAT> >
{
    private:
		int _x, _y, _z;
		std::vector<Vec23D<FLOAT> > vectorfield;
         /** initializes the data of the scalar field by zeros. */
         void initialize(){
           // TODO WORKSHEET 1
    ...
    public:
        ...
        VectorField ( int Nx, int Ny ){
          // TODO WORKSHEET 1
        	_x = Nx + 3;
        	_y = Ny + 3;
        	vectorfield = new Field<Vec23D<FLOAT> > (_x, _y, _z = 0, 2);
        }
        ...
        VectorField ( int Nx, int Ny, int Nz ){
          // TODO WORKSHEET 1
        	...
        	_y = Ny + 3;
        	_z = Nz + 3;
        	vectorfield = new Field<Vec23D<FLOAT> > (_x, _y, _z = 0, 3);
        }
         ...
         * @param k z index
         */
        Vec23D<FLOAT> getVector ( int i, int j, int k = 0 ){
          // TODO WORKSHEET 1
        	if ((i < _x) && (j < _y) && (k < _z)){
        		if (k != 0 ){
        			return vectorfield[i][j][k];
        		}
        		else {
    ...
    public:
        ...
        IntScalarField ( int Nx, int Ny ){
          // TODO WORKSHEET 1
        	_x = Nx + 3;
        	_y = Ny + 3;
        	flagfield = new Field<int> (_x, _y, _z = 0, 1);
        }
        ...
        IntScalarField ( int Nx, int Ny, int Nz ){
          // TODO WORKSHEET 1
        	...
        	_y = Ny + 3;
        	_z = Nz + 3;
        	flagfield = new Field<int> (_x, _y, _z, 1);
        }
