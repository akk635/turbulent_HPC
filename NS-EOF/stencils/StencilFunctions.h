...
inline void loadLocalVelocity2D( FlowField & flowField, FLOAT * const localVelocity, int i,
                                 int j ) {
...
void loadLocalVelocity3D( FlowField & flowField, FLOAT * const localVelocity, int i, int j,
                          int k ) {
...
// load local viscosity
void loadLocalViscosity3D( FlowField & flowField, FLOAT * const localViscosity, int i, int j,
                           int k ) {
    for ( int layer = -1; layer <= 1; layer++ ) {
        for ( int row = -1; row <= 1; row++ ) {
            for ( int column = -1; column <= 1; column++ ) {
                const FLOAT point = flowField.getViscosity().getScalar( i + column, j + row,
                                                                              k + layer );
    ...
    return 1.0 / 4.0
            * ( ( ( ( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 0, 1, 0, 0 )] )
                    * ( lv[mapd( 0, 0, 0, 1 )] + lv[mapd( 1, 0, 0, 1 )] ) )
                    ...
                    + parameters.solver.gamma
                            * ( ( fabs( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 0, 1, 0, 0 )] )
                                    * ( lv[mapd( 0, 0, 0, 1 )] - lv[mapd( 1, 0, 0, 1 )] ) )
    ...
    return 1.0 / 4.0
            * ( ( ( ( lv[mapd( 0, 0, 0, 1 )] + lv[mapd( 1, 0, 0, 1 )] )
                    * ( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 0, 1, 0, 0 )] ) )
                    ...
                    + parameters.solver.gamma
                            * ( ( fabs( lv[mapd( 0, 0, 0, 1 )] + lv[mapd( 1, 0, 0, 1 )] )
                                    * ( lv[mapd( 0, 0, 0, 0 )] - lv[mapd( 0, 1, 0, 0 )] ) )
    ...
    return 1.0 / 4.0
            * ( ( ( ( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 0, 0, 1, 0 )] )
                    * ( lv[mapd( 0, 0, 0, 2 )] + lv[mapd( 1, 0, 0, 2 )] ) )
                    ...
                    + parameters.solver.gamma
                            * ( ( fabs( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 0, 0, 1, 0 )] )
                                    * ( lv[mapd( 0, 0, 0, 2 )] - lv[mapd( 1, 0, 0, 2 )] ) )
    ...
    return 1.0 / 4.0
            * ( ( ( ( lv[mapd( 0, 0, 0, 2 )] + lv[mapd( 1, 0, 0, 2 )] )
                    * ( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 0, 0, 1, 0 )] ) )
                    ...
                    + parameters.solver.gamma
                            * ( ( fabs( lv[mapd( 0, 0, 0, 2 )] + lv[mapd( 1, 0, 0, 2 )] )
                                    * ( lv[mapd( 0, 0, 0, 0 )] - lv[mapd( 0, 0, 1, 0 )] ) )
    ...
    return 1.0 / 4.0
            * ( ( ( ( lv[mapd( 0, 0, 0, 1 )] + lv[mapd( 0, 0, 1, 1 )] )
                    * ( lv[mapd( 0, 0, 0, 2 )] + lv[mapd( 0, 1, 0, 2 )] ) )
                    ...
                    + parameters.solver.gamma
                            * ( ( fabs( lv[mapd( 0, 0, 0, 1 )] + lv[mapd( 0, 0, 1, 1 )] )
                                    * ( lv[mapd( 0, 0, 0, 2 )] - lv[mapd( 0, 1, 0, 2 )] ) )
            ...
            * ( ( ( ( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 1, 0, 0, 0 )] )
                    * ( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 1, 0, 0, 0 )] ) )
                    - ( ( lv[mapd( -1, 0, 0, 0 )] + lv[mapd( 0, 0, 0, 0 )] )
                            * ( lv[mapd( -1, 0, 0, 0 )] + lv[mapd( 0, 0, 0, 0 )] ) ) )
                    + parameters.solver.gamma
                            * ( ( fabs( lv[mapd( 0, 0, 0, 0 )] + lv[mapd( 1, 0, 0, 0 )] )
                                    * ( lv[mapd( 0, 0, 0, 0 )] - lv[mapd( 1, 0, 0, 0 )] ) )
            ...
            * ( ( ( ( lv[mapd( 0, 0, 0, 1 )] + lv[mapd( 0, 1, 0, 1 )] )
                    * ( lv[mapd( 0, 0, 0, 1 )] + lv[mapd( 0, 1, 0, 1 )] ) )
                    - ( ( lv[mapd( 0, -1, 0, 1 )] + lv[mapd( 0, 0, 0, 1 )] )
                            * ( lv[mapd( 0, -1, 0, 1 )] + lv[mapd( 0, 0, 0, 1 )] ) ) )
                    + parameters.solver.gamma
                            * ( ( fabs( lv[mapd( 0, 0, 0, 1 )] + lv[mapd( 0, 1, 0, 1 )] )
                                    * ( lv[mapd( 0, 0, 0, 1 )] - lv[mapd( 0, 1, 0, 1 )] ) )
            ...
            * ( ( ( ( lv[mapd( 0, 0, 0, 2 )] + lv[mapd( 0, 0, 1, 2 )] )
                    * ( lv[mapd( 0, 0, 0, 2 )] + lv[mapd( 0, 0, 1, 2 )] ) )
                    - ( ( lv[mapd( 0, 0, -1, 2 )] + lv[mapd( 0, 0, 0, 2 )] )
                            * ( lv[mapd( 0, 0, -1, 2 )] + lv[mapd( 0, 0, 0, 2 )] ) ) )
                    + parameters.solver.gamma
                            * ( ( fabs( lv[mapd( 0, 0, 0, 2 )] + lv[mapd( 0, 0, 1, 2 )] )
                                    * ( lv[mapd( 0, 0, 0, 2 )] - lv[mapd( 0, 0, 1, 2 )] ) )
...
// Helper functions for turbulence
inline FLOAT abvAvgXYtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 1, 0, 0, 0 )]
            + lvis[mapd( 0, 1, 0, 0 )] + lvis[ mapd( 1, 1, 0, 0 )] ) / 4;
}

inline FLOAT belAvgXYtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 1, 0, 0, 0 )]
            + lvis[mapd( 0, -1, 0, 0 )] + lvis[ mapd( 1, -1, 0, 0 ) ] ) / 4;
}

inline FLOAT abvAvgXZtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 1, 0, 0, 0 )]
            + lvis[mapd( 0, 0, 1, 0 )] + lvis[ mapd( 1, 0, 1, 0 ) ] ) / 4;
}

inline FLOAT belAvgXZtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 1, 0, 0, 0 )]
            + lvis[mapd( 0, 0, -1, 0 )] + lvis[ mapd( 1, 0, -1, 0 ) ] ) / 4;
}

inline FLOAT abvAvgYZtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 0, 1, 0, 0 )]
            + lvis[mapd( 0, 0, 1, 0 )] + lvis[ mapd( 0, 1, 1, 0 ) ] ) / 4;
}

inline FLOAT belAvgYZtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 0, 1, 0, 0 )]
            + lvis[mapd( 0, 0, -1, 0 )] + lvis[ mapd( 0, 1, -1, 0 ) ] ) / 4;
}

inline FLOAT belAvgYXtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 0, 1, 0, 0 )]
            + lvis[mapd( -1, 0, 0, 0 )] + lvis[ mapd( -1, 1, 0, 0 ) ] ) / 4;
}

inline FLOAT belAvgZXtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 0, 0, 1, 0 )]
            + lvis[mapd( -1, 0, 0, 0 )] + lvis[ mapd( -1, 0, 1, 0 ) ] ) / 4;
}

inline FLOAT belAvgZYtvis( const FLOAT * const lvis ) {
    return ( lvis[mapd( 0, 0, 0, 0 )] + lvis[mapd( 0, 0, 1, 0 )]
            + lvis[mapd( 0, -1, 0, 0 )] + lvis[ mapd( 0, -1, 1, 0 ) ] ) / 4;
}

// New functions for FGH algebraic turbulence modelling
inline FLOAT tau11( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / ( parameters.geometry.dx * parameters.geometry.dx ) )
            * ( ( ( lvis[mapd( 1, 0, 0, 0 )] + ( 1 / parameters.flow.Re ) )
                    * ( lv[mapd( 1, 0, 0, 0 )] - lv[mapd( 0, 0, 0, 0 )] ) )
                    - ( ( lvis[mapd( 0, 0, 0, 0 )] + ( 1 / parameters.flow.Re ) )
                            * ( lv[mapd( 0, 0, 0, 0 )] - lv[mapd( -1, 0, 0, 0 )] ) ) );
}

inline FLOAT tau12( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / parameters.geometry.dy )
            * ( ( ( abvAvgXYtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                    * ( ( ( lv[mapd( 0, 1, 0, 0 )] - lv[mapd( 0, 0, 0, 0 )] )
                            / parameters.geometry.dy )
                            + ( ( lv[mapd( 1, 0, 0, 1 )] - lv[mapd( 0, 0, 0, 1 )] )
                                    / parameters.geometry.dx ) ) )
                    - ( ( belAvgXYtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                            * ( ( ( lv[mapd( 0, 0, 0, 0 )] - lv[mapd( 0, -1, 0, 0 )] )
                                    / parameters.geometry.dy )
                                    + ( ( lv[mapd( 1, -1, 0, 1 )] - lv[mapd( 0, -1, 0, 1 )] )
                                            / parameters.geometry.dx ) ) ) );
}

inline FLOAT tau13( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / parameters.geometry.dz )
            * ( ( ( abvAvgXZtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                    * ( ( ( lv[mapd( 0, 0, 1, 0 )] - lv[mapd( 0, 0, 0, 0 )] )
                            / parameters.geometry.dz )
                            + ( ( lv[mapd( 1, 0, 0, 2 )] - lv[mapd( 0, 0, 0, 2 )] )
                                    / parameters.geometry.dx ) ) )
                    - ( ( belAvgXZtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                            * ( ( ( lv[mapd( 0, 0, 0, 0 )] - lv[mapd( 0, 0, -1, 0 )] )
                                    / parameters.geometry.dz )
                                    + ( ( lv[mapd( 1, 0, -1, 2 )] - lv[mapd( 0, 0, -1, 2 )] )
                                            / parameters.geometry.dx ) ) ) );
}

inline FLOAT tau21( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / parameters.geometry.dx )
            * ( ( ( abvAvgXYtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                    * ( ( ( lv[mapd( 1, 0, 0, 1 )] - lv[mapd( 0, 0, 0, 1 )] )
                            / parameters.geometry.dx )
                            + ( ( lv[mapd( 0, 1, 0, 0 )] - lv[mapd( 0, 0, 0, 0 )] )
                                    / parameters.geometry.dy ) ) )
                    - ( ( belAvgYXtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                            * ( ( ( lv[mapd( 0, 0, 0, 1 )] - lv[mapd( -1, 0, 0, 1 )] )
                                    / parameters.geometry.dx )
                                    + ( ( lv[mapd( -1, 1, 0, 0 )] - lv[mapd( -1, 0, 0, 0 )] )
                                            / parameters.geometry.dy ) ) ) );
}

inline FLOAT tau22( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / ( parameters.geometry.dy * parameters.geometry.dy ) )
            * ( ( ( lvis[mapd( 0, 1, 0, 0 )] + ( 1 / parameters.flow.Re ) )
                    * ( lv[mapd( 0, 1, 0, 1 )] - lv[mapd( 0, 0, 0, 1 )] ) )
                    - ( ( lvis[mapd( 0, 0, 0, 0 )] + ( 1 / parameters.flow.Re ) )
                            * ( lv[mapd( 0, 0, 0, 1 )] - lv[mapd( 0, -1, 0, 1 )] ) ) );
}

inline FLOAT tau23( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / parameters.geometry.dz )
            * ( ( ( abvAvgYZtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                    * ( ( ( lv[mapd( 0, 0, 1, 1 )] - lv[mapd( 0, 0, 0, 1 )] )
                            / parameters.geometry.dz )
                            + ( ( lv[mapd( 0, 1, 0, 2 )] - lv[mapd( 0, 0, 0, 2 )] )
                                    / parameters.geometry.dy ) ) )
                    - ( ( belAvgYZtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                            * ( ( ( lv[mapd( 0, 0, 0, 1 )] - lv[mapd( 0, 0, -1, 1 )] )
                                    / parameters.geometry.dz )
                                    + ( ( lv[mapd( 0, 1, -1, 2 )] - lv[mapd( 0, 0, -1, 2 )] )
                                            / parameters.geometry.dy ) ) ) );
}

inline FLOAT tau31( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / parameters.geometry.dx )
            * ( ( ( abvAvgXZtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                    * ( ( ( lv[mapd( 1, 0, 0, 2 )] - lv[mapd( 0, 0, 0, 2 )] )
                            ...
                            + ( ( lv[mapd( 0, 0, 1, 0 )] - lv[mapd( 0, 0, 0, 0 )] )
                                    / parameters.geometry.dz ) ) )
                    - ( ( belAvgZXtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                            * ( ( ( lv[mapd( 0, 0, 0, 2 )] - lv[mapd( -1, 0, 0, 2 )] )
                                    / parameters.geometry.dx )
                                    + ( ( lv[mapd( -1, 0, 1, 0 )] - lv[mapd( -1, 0, 0, 0 )] )
                                            / parameters.geometry.dz ) ) ) );
}

inline FLOAT tau32( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / parameters.geometry.dy )
            * ( ( ( abvAvgYZtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                    * ( ( ( lv[mapd( 0, 1, 0, 2 )] - lv[mapd( 0, 0, 0, 2 )] )
                            ...
                            + ( ( lv[mapd( 0, 0, 1, 1 )] - lv[mapd( 0, 0, 0, 1 )] )
                                    / parameters.geometry.dz ) ) )
                    - ( ( belAvgZYtvis( lvis ) + ( 1 / parameters.flow.Re ) )
                            * ( ( ( lv[mapd( 0, 0, 0, 2 )] - lv[mapd( 0, -1, 0, 2 )] )
                                    / parameters.geometry.dy )
                                    + ( ( lv[mapd( 0, -1, 1, 1 )] - lv[mapd( 0, -1, 0, 1 )] )
                                            / parameters.geometry.dz ) ) ) );
}

inline FLOAT tau33( const FLOAT * const lv, const FLOAT * const lvis,
                    const Parameters & parameters ) {
    return ( 1 / ( parameters.geometry.dz * parameters.geometry.dz ) )
            * ( ( ( lvis[mapd( 0, 0, 1, 0 )] + ( 1 / parameters.flow.Re ) )
                    * ( lv[mapd( 0, 0, 1, 2 )] - lv[mapd( 0, 0, 0, 2 )] ) )
                    - ( ( lvis[mapd( 0, 0, 0, 0 )] + ( 1 / parameters.flow.Re ) )
                            * ( lv[mapd( 0, 0, 0, 2 )] - lv[mapd( 0, 0, -1, 2 )] ) ) );
}

inline FLOAT computeF2D( const FLOAT * const localVelocity, const Parameters & parameters,
                         FLOAT dt ) {
    return localVelocity[mapd( 0, 0, 0, 0 )]
            + dt
                    * ( 1 / parameters.flow.Re
                            * ( d2udx2( localVelocity, parameters )
                                    + d2udy2( localVelocity, parameters ) )
                            - du2dx( localVelocity, parameters )
                            - duvdy( localVelocity, parameters ) + parameters.environment.gx );
}

inline FLOAT computeG2D( const FLOAT * const localVelocity, const Parameters & parameters,
                         FLOAT dt ) {
    return localVelocity[mapd( 0, 0, 0, 1 )]
            + dt
                    * ( 1 / parameters.flow.Re
                            * ( d2vdx2( localVelocity, parameters )
                                    + d2vdy2( localVelocity, parameters ) )
                            - duvdx( localVelocity, parameters )
                            - dv2dy( localVelocity, parameters ) + parameters.environment.gy );
}

inline FLOAT computeF3D( const FLOAT * const localVelocity, const FLOAT * const localViscosity,
                         const Parameters & parameters, FLOAT dt ) {
    return localVelocity[mapd( 0, 0, 0, 0 )]
            + dt
                    * ( 2 * tau11( localVelocity, localViscosity, parameters )
                            + tau12( localVelocity, localViscosity, parameters )
                            + tau13( localVelocity, localViscosity, parameters )
                            - du2dx( localVelocity, parameters )
                            - duvdy( localVelocity, parameters )
                            - duwdz( localVelocity, parameters ) + parameters.environment.gx );
}

inline FLOAT computeG3D( const FLOAT * const localVelocity, const FLOAT * const localViscosity,
                         const Parameters & parameters, FLOAT dt ) {
    return localVelocity[mapd( 0, 0, 0, 1 )]
            + dt
                    * ( tau21( localVelocity, localViscosity, parameters )
                            + 2 * tau22( localVelocity, localViscosity, parameters )
                            + tau23( localVelocity, localViscosity, parameters )
                            - dv2dy( localVelocity, parameters )
                            - duvdx( localVelocity, parameters )
                            - dvwdz( localVelocity, parameters ) + parameters.environment.gy );
}

inline FLOAT computeH3D( const FLOAT * const localVelocity, const FLOAT * const localViscosity,
                         const Parameters & parameters, FLOAT dt ) {
    return localVelocity[mapd( 0, 0, 0, 2 )]
            + dt
                    * ( tau31( localVelocity, localViscosity, parameters )
                            + tau32( localVelocity, localViscosity, parameters )
                            + 2 * tau33( localVelocity, localViscosity, parameters )
                            - dw2dz( localVelocity, parameters )
                            - duwdx( localVelocity, parameters )
